...
addT8 (T8 a b c d e f g h) (T8 a1 b1 c1 d1 e1 f1 g1 h1) = T8 (a+a1) (b+b1) (c+c1) (d+d1) (e+e1) (f+f1) (g+g1) (h+h1)
...
rotate8 :: T8 -> T64 -> T8
rotate8 h w = foldl (\a' i -> rotate8' a' i) h (0:>8:>16:>24:>32:>40:>48:>56:>Nil) --[0,8..63]
  where
    rotate8' a0' i = foldl (\a j -> rotate' $ rotate1 a (k!!!(i + j)) (w!!!(i + j))) a0' (0:>1:>2:>3:>4:>5:>6:>7:>Nil) --[0..7]
...
sha256shuffle w16 =
  foldl (\ww i -> setV ww i (s1 (ww !!! (i-2)) + (ww !!! (i-7)) + s0 (ww !!! (i-15)) + (ww !!! (i-16)))) (toT64 w16)
...
sha256_do_chunk (h, w16) = h `addT8` (rotate8 h $ sha256shuffle w16)

topEntity
  :: Clock  System Source
  -> Reset  System Asynchronous
  -> Signal System (T8,T16)
  -> Signal System (T8)
topEntity = exposeClockReset (\a -> sha256_do_chunk <$> a)
{-# NOINLINE topEntity #-}
